...
set.signcolumn = "auto"
set.cursorline = true
--  set.cursorcolumn = true -- this might cause cursor glitching when expending snippets, see https://www.reddit.com/r/neovim/comments/1di73oi/cursor_glitching_out_when_snippets_are_used_in/
set.expandtab = true
set.cindent = true
set.shiftwidth = 2
set.softtabstop = 2
